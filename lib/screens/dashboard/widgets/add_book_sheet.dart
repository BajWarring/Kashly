...
class _AddBookSheetState extends State<AddBookSheet> {
  ...
  // Default to INR
  Currency _selectedCurrency = worldCurrencies.firstWhere(
    (c) => c.code == 'INR',
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setModalState) {
          final filteredList = worldCurrencies
              .where((c) =>
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (c, i) => ListTile(
                      leading: Container(
                        ...
                        child: Text(filteredList[i].symbol,
                            style: const TextStyle(
                                fontWeight: FontWeight.bold,
                                color: textDark,
                                fontSize: 16)),
                      ),
                      title: Text(filteredList[i].code,
                          style: const TextStyle(fontWeight: FontWeight.bold)),
                      subtitle: Text(filteredList[i].name),
                      trailing: _selectedCurrency.code == filteredList[i].code
          ...
          children: [
            Center(
              child: Container(
                ...
                height: 5,
                decoration: BoxDecoration(
                    color: borderCol, borderRadius: BorderRadius.circular(10)),
                margin: const EdgeInsets.only(bottom: 20),
              ),
            ),
            const Text('New Cashbook',
                style: TextStyle(
                    fontSize: 22,
                    fontWeight: FontWeight.bold,
                    color: textDark)),
